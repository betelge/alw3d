...
public class FBOAttachable {
	...
	public enum Format {
		GL_RGB565(GLES20.GL_RGB, GLES20.GL_RGB565, 2), GL_RGBA4(GLES20.GL_RGBA,
				GLES20.GL_RGBA4, 2), GL_RGB5_A1(GLES20.GL_RGBA,
				GLES20.GL_RGB5_A1, 2),
				
		GL_DEPTH_COMPONENT(0, GLES20.GL_DEPTH_COMPONENT, 2), GL_STENCIL_INDEX(0,
				GLES20.GL_STENCIL_INDEX, 1),
